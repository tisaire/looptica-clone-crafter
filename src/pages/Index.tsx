...
const CURRENT_VERSION = "v2.3.0-canonical-nonwww-cleanup"; // Canonical/hreflang/og:url normalized to https://looptica.com (no www); hreflang added to About + legal pages; duplicate hreflang removed from PlanVeo
...
const Index = () => {
  ...
  const content = {
    meta: {
      ...
      es: {
        title: "Óptica en Poblenou, Barcelona | Gafas, Lentillas y Audiología",
        description: "Óptica y centro auditivo en Poblenou, Barcelona. Gafas graduadas, lentillas, Orto-K, revisión visual y audífonos. Atención personalizada en Looptica.",
