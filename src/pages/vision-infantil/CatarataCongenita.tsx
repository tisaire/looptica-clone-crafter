...
const intro = {
  ca: [
    ...
    "A Looptica fem aquesta correcció amb lentilles de contacte pediàtriques, adaptades des dels 0 anys, sempre seguint la prescripció i les indicacions de l'oftalmòleg.",
  ],
  es: [
