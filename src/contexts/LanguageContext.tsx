...
export const translations: Translations = {
  ...
  orthoKDesc: {
    en: 'Overnight contact lenses for myopia and astigmatism — clear daytime vision without glasses. Ideal for myopia control in children.',
    es: 'Lentillas nocturnas para miopía y astigmatismo — visión nítida de día sin gafas. Ideales para el control de miopía infantil.',
    ca: 'Lentilles nocturnes per a miopia i astigmatisme — visió nítida de dia sense ulleres. Ideals per al control de miopia infantil.',
    de: 'Nachtkontaktlinsen für Kurzsichtigkeit und Astigmatismus — klares Tagessehen ohne Brille. Ideal für die Myopie-Kontrolle bei Kindern.',
  },
  imageConsulting: {
    en: 'Image Consulting',
